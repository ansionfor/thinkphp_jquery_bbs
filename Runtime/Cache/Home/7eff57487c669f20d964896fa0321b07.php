...
<div class="row">
		<div class="col-md-12">
			<div class="list-header">
				<span class="list-title"><?php echo ($category_meta["name"]); ?></span>

			</div> 
      <a href="<?php echo U('Index/postArticle',array('id'=>$category_meta['category_id']));?>"><button type="button" class="btn btn-primary post">我要发贴</button></a>
			<div class="list-body task-list">
				<ul>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
					<p>
					<a href="<?php echo U('Index/articlePage',array('id'=>$vo['category_id'],'aid'=>$vo['article_id']));?>">
					<span class="task-time"><?php echo (date("H:i",$vo["create_time"])); ?></span><?php echo ($vo["title"]); ?>
					</a>
					<span class="task-info pull-right">
					<span class="task-time-full"><?php echo (date("y-m-d H:i",$vo["create_time"])); ?></span>
					</span>
					</p>
