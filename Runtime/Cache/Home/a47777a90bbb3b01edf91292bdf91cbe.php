...
<div class="row">
  ...
  <div class="panel-body">
    ...
    <div class="post-info" style="margin-top:10px">作者：<a href="<?php echo U('Index/memberPub',array('mid'=>$task['member_id']));?>"><?php echo ($task["name"]); ?></a><br>发布时间：<?php echo (date("y-m-d H:i",$task["create_time"])); ?> <br><span>接受人数：<?php echo ($task["confirm"]); ?></span></div>
  </div>
