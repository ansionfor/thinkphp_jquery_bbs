...
<div class="row">
		<div class="col-md-12">
			<div class="list-header">
				<span class="list-title"><?php echo ($category_meta["name"]); ?>列表</span>
			</div>
			<a href="<?php echo U('Index/postTask');?>"><button type="button" class="btn btn-primary post">我要发<?php echo ($category_meta["name"]); ?></button></a>
			<div class="list-body task-list">
				...
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
					...
					<span class="task-info pull-right"><span class="task-time-full"><?php echo (date("y-m-d H:i",$vo["create_time"])); ?></span></span>
					</p>
